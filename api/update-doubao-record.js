// Vercel Serverless Function - 通用更新豆包Demo记录
// 部署后通过 POST /api/update-doubao-record?model=gemini3|gpt52|skills 访问
...
// 多模型表格配置映射
const TABLE_CONFIGS = {
  gemini3: { doubaoTable: 'tblj14LfBtbNpSNR', name: 'Gemini 3' },
  gpt52: { doubaoTable: 'tbltvxTCco9qZZyj', name: 'GPT 5.2' },
  skills: { doubaoTable: 'tblyEaRH1YpwAPxQ', name: 'Skills' }
};
